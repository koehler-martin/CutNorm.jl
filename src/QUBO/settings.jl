...
Settings for [`QUBOSolver`](@ref), the exact binary-quadratic program (QUBO) formulation.
...
See also [`cutnorm`](@ref), [`QUBOSolver`](@ref).
"""
Base.@kwdef mutable struct QUBOSettings <: AbstractSettings
