@testset "QUBO Types" begin
    ...
    sol2 = QUBOSolution(3, 4)
    @test sol2.dims == (3, 4)
    @test length(sol2.S) == 3
    @test length(sol2.T) == 4

    sol3 = QUBOSolution(Float32, 2, 3)
    @test sol3.dims == (2, 3)
